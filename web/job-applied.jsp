...
<head>
    ...
    <title>Job Applied | Emprego</title>
...
<body>
    ...
    <section>
        <div class="container">
            <h2 class="title text-center">Job Applied</h2><br><br><br>
            <div class="row">
                <div class="product-information"><!--/product-information-->
                    <c:forEach items="${applied}" var="post">
                        <div class="alert alert-info">
                            <h4><c:out value="${post.getDesignation()}"/><span style="float: right;color: #2b542c"><c:out value="${post.getStatus()}"/></span></h4>
                            <p><c:out value="${post.getCompanyName()}"/></p>
