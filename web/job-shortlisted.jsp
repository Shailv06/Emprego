...
<head>
    ...
    <title>Job Shorlisted | Emprego</title>
...
<body>
    ...
    <section>
        <div class="container">
            <h2 class="title text-center">Job Shortlisted</h2><br><br><br>
            <div class="row">
                <div class="product-information"><!--/product-information-->
                    <c:forEach items="${spost}" var="post">
                        <div class="alert alert-danger">
                            <h4><c:out value="${post.getDesignation()}"/></h4>
